...
public:
    ...
    virtual ~Graphics();
	void init(int argc, char** argv, CPointPH* neInitCoordination, CPointPH* neEndCoordination, string fileNameBMP);
...
private:
	CPointPH neInitialCoordinate;
	CPointPH neFinalCoordinate;
